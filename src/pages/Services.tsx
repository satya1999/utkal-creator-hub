...
const services = [
  {
    ...
    features: [
      "Nano & micro-influencer partnerships across 30 Odisha districts",
      "Category-specific matching — food, travel, health, lifestyle, Odia culture",
      "End-to-end campaign management from Balasore to Berhampur",
